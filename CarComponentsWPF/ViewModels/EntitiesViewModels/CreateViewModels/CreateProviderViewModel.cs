...
{
    public class CreateProviderViewModel : CreateEntityViewModel<Provider>
    {
        public CreateProviderViewModel(IDataService<Provider> service, Provider entity) : base(service, entity)
        {
        }
