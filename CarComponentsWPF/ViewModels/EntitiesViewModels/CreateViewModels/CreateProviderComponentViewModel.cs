...
{
    public class CreateProviderComponentViewModel : CreateEntityViewModel<ProviderComponent>
    {
        ...
        public CreateProviderComponentViewModel(IDataService<ProviderComponent> service, List<Component> componentfList, List<Provider> providerList, ProviderComponent entity) : base(service, entity)
        {
