...
{
    public class DeleteComponentTypeViewModel : DeleteEntityViewModel<ComponentType>
    {
        public DeleteComponentTypeViewModel(IDataService<ComponentType> service, ComponentType entity) : base(service, entity)
        {
        }
